...
samples <- read.csv("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/all_sample_data.csv", 
                    stringsAsFactors = F, 
                    row.names = 1)
...
bacteria <- read.table("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/16S/greengenes2/otu_table_16S_gg2.tsv", 
                       sep = "\t", 
                       row.names = 1, 
                       header = T)
...
bacteria.tax <- read.table("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/16S/greengenes2/taxonomy.tsv", 
                           sep = "\t", 
                           header = T)
...
source("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/scripts/taxaLabels_for_gg2_16S.R")
...
fungi <- read.table("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/ITS/otu_table_its1_97.txt", 
                    sep = "\t", 
                    header=T, 
                    row.names = 1)

all.tax <- read.table("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/ITS/taxonomy_otus.txt", 
                      sep = "\t", 
                      header = F)
...
# add taxa labels
source("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/scripts/taxaLabels_species_level.R")
...
funguild <- read.table("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/ITS/funguild_otu_table.guilds_matched.txt", 
                       sep = "\t", 
                       header = T)

guilds <- funguild[,c(1,72:81)]

fungi.tax.ref <- read.csv("/Users/sonya.erlandson/OneDrive - USDA/greenhouse crop identity 2022/data tables/ITS/fungi_reformatted_taxonomy.csv")
